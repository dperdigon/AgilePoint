...
SELECT	
    ...
    [Completed Date]    = ISNULL(CONVERT(VARCHAR(20), MW.COMPLETED_DATE, 101) + ' ' + CONVERT(VARCHAR(20), MW.COMPLETED_DATE, 108), CONVERT(VARCHAR(20), MW.CANCELLED_DATE, 101) + ' ' + CONVERT(VARCHAR(20), MW.CANCELLED_DATE, 108))
